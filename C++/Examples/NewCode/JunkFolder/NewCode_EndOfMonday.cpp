...
//			winch_left_cmd = LINE_NEUTRAL;
			...
			//winch_right_cmd = step_counter*STEP_SIZE;
			//winch_left_cmd = step_counter*STEP_SIZE

//			cout << "this is the calculated command: " << step_counter*STEP_SIZE << endl;
			...
			{
				//cout << time_now << endl;
				//cout << "right side command is: " << step_counter*STEP_SIZE;
				//cout << "left side command is: " << LINE_NEUTRAL - LINE_OFFSET << endl;
				if(multisine_counter < 61) // should be 60 s
				{
					//cout << "this is happening";
					winch_right_cmd = LINE_NEUTRAL+LINE_OFFSET-.075*(sin(.2094*t-0.6111)+sin(.4189*t-1.3593)+sin(0.8976*t-.8035)+sin(2.0944*t+2.6684)+sin(2.8274*t-1.2069)+sin(3.7699*t+2.8186)+sin(4.7124*t-.8956)+sin(5.3407*t+1.8869)+sin(6.2832*t+2.1591));
					winch_left_cmd = LINE_NEUTRAL+LINE_OFFSET;


//					winch_right_cmd = LINE_NEUTRAL-LINE_OFFSET+.075*(sin(.2094*t-0.6111)+sin(.4189*t-1.3593)+sin(0.8976*t-.8035)+sin(2.0944*t+2.6684)+sin(2.8274*t-1.2069)+sin(3.7699*t+2.8186)+sin(4.7124*t-.8956)+sin(5.3407*t+1.8869)+sin(6.2832*t+2.1591));					winch_right_cmd = LINE_NEUTRAL+LINE_OFFSET+.2*(sin(.2094*t-0.6111)+sin(.4189*t-1.3593)+sin(0.8976*t-.8035)+sin(2.0944*t+2.6684)+sin(2.8274*t-1.2069)+sin(3.7699*t+2.8186)+sin(4.7124*t-.8956)+sin(5.3407*t+1.8869)+sin(6.2832*t+2.1591));
//					winch_left_cmd = LINE_NEUTRAL+LINE_OFFSET;
				}
				else
				{
...
//				winch_left_cmd = LINE_NEUTRAL-LINE_OFFSET;
			...
			{
				//cout << "left side command is: " << step_counter*STEP_SIZE;
				//cout << "right side command is: " << LINE_NEUTRAL - LINE_OFFSET << endl;
				if(multisine_counter < 61)
				{
					winch_left_cmd = LINE_NEUTRAL+LINE_OFFSET+.075*(sin(.2094*t-0.6111)+sin(.4189*t-1.3593)+sin(0.8976*t-.8035)+sin(2.0944*t+2.6684)+sin(2.8274*t-1.2069)+sin(3.7699*t+2.8186)+sin(4.7124*t-.8956)+sin(5.3407*t+1.8869)+sin(6.2832*t+2.1591));
