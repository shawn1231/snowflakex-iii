...
const float total_time = 60; // total duration of the designed sweep in seconds
const float sweep_amp = 35; // maximum positive amplitude of the sweep, signal is symmetrical as expected
float phi = 0;
float wmin = 0.1; // Hz
float wmax = 20; // Hz
float c1 = 4;
